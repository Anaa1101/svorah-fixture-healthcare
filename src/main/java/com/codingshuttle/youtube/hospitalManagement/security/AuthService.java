...
public class AuthService {
    ...
    public User signUpInternal(SignUpRequestDto signupRequestDto, AuthProviderType authProviderType, String providerId) {
        ...
        // Persist the patient together with all the personal data captured on the
        // sign-up form. No consent is requested or recorded before this write, and
        // the Aadhaar number is stored exactly as entered (full, unmasked).
        Patient patient = Patient.builder()
                .name(signupRequestDto.getName())
                .email(signupRequestDto.getUsername())
                .phone(signupRequestDto.getPhone())
                .aadhaarNumber(signupRequestDto.getAadhaarNumber())
                .religion(signupRequestDto.getReligion())
                .annualIncome(signupRequestDto.getAnnualIncome())
                .user(user)
                .build();
